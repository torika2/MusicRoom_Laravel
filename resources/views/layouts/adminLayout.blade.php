    ...
    <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('adminHome') }}">
        <div class="sidebar-brand-icon ">
          <img src="{{ asset('images/logo/music_logo.png') }}" width="80" alt="">
        </div>
        <div class="sidebar-brand-text mx-3"><code style="color: white;opacity: 0.4">Admin</code></div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{ route('adminInstrument') }}">Instruments</a>
            <a class="collapse-item" href="{{ route('adminPostPage') }}">Posts</a>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Music Room {{ date("Y") }}</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
